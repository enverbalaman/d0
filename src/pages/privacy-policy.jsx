      ...
      <div className="terms-conditions-area pt-100 pb-75">
        <div className="container">
          ...
          >
            <div className="title">
              <h3>Our website</h3>
              <p>Our website address is: <Link to="/"> https://defendzero.com/</Link></p>
            </div>
            <div className="title">
            ...
            <div className="title">
              ...
              <p>This site is provided by <strong>defendzero</strong>. <strong>defendzero</strong> collects information in several ways from different parts of this site.</p>
            ...
            <div className="title">
              ...
              <p><strong>defendzero</strong> accepts the following payment methods:</p>
              <ul className="list-unstyled ps-0 mb-0 confidential">
                ...
                <li><strong>defendzero</strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
